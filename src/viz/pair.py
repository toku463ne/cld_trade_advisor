"""Side-by-side pair chart with optional zigzag overlay."""
...
from src.viz.price import empty_figure

# ZigzagPoint = (date_str, price, direction)   direction: 2=conf high, -2=conf low
...
def build_pair_figure(
    ...
    """4-row subplot (shared x-axis): A price / A vol / B price / B vol.
