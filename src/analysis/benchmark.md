...
| brk_sma    |   172 |  34.3% | <0.001  |    0.0200 |    0.1038 |    14.663 | <0.001  | 172 (×1.0) |    34.3% | —             | —             |
...
| brk_sma    |   238 |  55.0% | ≈0.120  |    0.0674 |    0.0310 |    13.055 | <0.001  | 238 (×1.0) |    55.0% | 65.4% (≈0.001) | 44.1% (≈0.197) |
...
| brk_sma    |   197 |  50.3% | ≈0.943  |    0.0433 |    0.0431 |    12.457 | <0.001  | 197 (×1.0) |    50.3% | 57.1% (≈0.232) | 48.0% (≈0.652) |
...
| brk_sma    |   189 |  58.7% | ≈0.016  |    0.0469 |    0.0282 |    12.561 | <0.001  | 189 (×1.0) |    58.7% | 50.0% (≈1.000) | 66.7% (<0.001) |
...
| brk_sma    |   179 |  55.9% | ≈0.117  |    0.0534 |    0.0307 |    12.760 | <0.001  | 179 (×1.0) |    55.9% | 59.3% (≈0.075) | 52.0% (≈0.729) |
...
| brk_sma    |   265 |  56.2% | ≈0.043  |    0.0556 |    0.0328 |    12.777 | <0.001  | 265 (×1.0) |    56.2% | 59.0% (≈0.046) | 53.8% (≈0.358) |
...
| brk_sma    |   172 |  54.7% | ≈0.222  |    0.0601 |    0.0362 |    12.267 | <0.001  | 172 (×1.0) |    54.7% | 63.6% (≈0.070) | 50.0% (≈1.000) |
...
| brk_sma    |   7 |    1412 |      52.6% | ≈0.049   |       0.0495 |        0.0437 |       7/7 | 50.0–65.4%    | 44.1–66.7%    |
...
|------|------|---|---|---|---|-----------|-----------|-------|------|---------|
| **brk_bol** | high |   902 | +0.028 |  ≈0.400 | 0.703 | +0.006 | +0.048 | 0 | no | noise |
|            | mid  |  1269 | +0.011 |  ≈0.691 | 0.841 | -0.008 | +0.037 | 2 | no | noise |
...
|            | low  |   752 | -0.016 |  ≈0.663 | 0.841 | -0.036 | +0.004 | 1 | no | noise |
| **brk_sma** | high |   521 | -0.001 |  ≈0.990 | 0.990 | -0.031 | +0.031 | 4 | no | noise |
|            | mid  |   476 | +0.082 |  ≈0.073 | 0.294 | +0.058 | +0.113 | 0 | no | noise |
|            | low  |   230 | +0.027 |  ≈0.687 | 0.841 | +0.006 | +0.039 | 0 | no | noise |
| **brk_tenkan_hi** | high |  9122 | +0.028 |  ≈0.008 | 0.078 | +0.020 | +0.031 | 0 | no | noise |
|            | mid  |  9056 | +0.019 |  ≈0.066 | 0.285 | +0.014 | +0.025 | 0 | asc | noise |
|            | low  |  4438 | -0.021 |  ≈0.165 | 0.473 | -0.026 | -0.010 | 0 | no | noise |
| **brk_tenkan_lo** | high |  8580 | +0.034 |  ≈0.002 | 0.022 | +0.014 | +0.047 | 0 | asc | noise |
|            | mid  |  8460 | -0.005 |  ≈0.679 | 0.841 | -0.010 | +0.003 | 1 | no | noise |
|            | low  |  4112 | -0.021 |  ≈0.171 | 0.473 | -0.028 | -0.008 | 0 | no | noise |
| **brk_wall** | high |  1530 | +0.028 |  ≈0.282 | 0.584 | +0.015 | +0.042 | 0 | no | noise |
|            | mid  |  1791 | -0.021 |  ≈0.364 | 0.680 | -0.040 | -0.001 | 0 | no | noise |
|            | low  |   980 | +0.092 |  ≈0.004 | 0.044 | +0.066 | +0.130 | 0 | asc | borderline |
| **chiko_hi** | high |  2306 | +0.009 |  ≈0.651 | 0.841 | -0.002 | +0.032 | 2 | asc | noise |
|            | mid  |  2672 | +0.011 |  ≈0.573 | 0.823 | +0.003 | +0.019 | 0 | no | noise |
|            | low  |  1422 | +0.066 |  ≈0.012 | 0.099 | +0.049 | +0.074 | 0 | no | borderline |
| **chiko_lo** | high |  2379 | +0.036 |  ≈0.079 | 0.295 | +0.010 | +0.061 | 0 | no | noise |
|            | mid  |  1949 | +0.038 |  ≈0.091 | 0.306 | +0.014 | +0.062 | 0 | asc | noise |
|            | low  |   958 | +0.023 |  ≈0.470 | 0.773 | +0.005 | +0.044 | 0 | no | noise |
| **corr_flip** | low  |   695 | -0.063 |  ≈0.099 | 0.309 | -0.080 | -0.042 | 0 | no | noise |
| **corr_shift** | mid  |   268 | +0.011 |  ≈0.861 | 0.927 | -0.048 | +0.094 | 2 | no | noise |
|            | low  |   877 | +0.031 |  ≈0.356 | 0.680 | -0.007 | +0.074 | 1 | no | noise |
...
| **div_peer** | high |   223 | +0.003 |  ≈0.962 | 0.980 | -0.036 | +0.047 | 4 | no | noise |
|            | mid  |   279 | -0.074 |  ≈0.220 | 0.536 | -0.088 | -0.041 | 0 | no | noise |
| **rev_hi** | high |  3215 | -0.024 |  ≈0.177 | 0.473 | -0.030 | -0.018 | 0 | no | noise |
|            | mid  |  3469 | -0.007 |  ≈0.676 | 0.841 | -0.013 | +0.003 | 1 | no | noise |
|            | low  |  1883 | +0.004 |  ≈0.846 | 0.927 | -0.026 | +0.038 | 2 | no | noise |
| **rev_lo** | high |  3101 | +0.001 |  ≈0.954 | 0.980 | -0.021 | +0.021 | 3 | no | noise |
|            | mid  |  2920 | +0.014 |  ≈0.437 | 0.742 | -0.012 | +0.030 | 2 | no | noise |
|            | low  |  1455 | +0.024 |  ≈0.362 | 0.680 | +0.013 | +0.041 | 0 | no | noise |
| **rev_nlo** | high |  1996 | +0.025 |  ≈0.260 | 0.565 | -0.077 | +0.076 | 1 | asc | noise |
|            | mid  |   758 | +0.024 |  ≈0.508 | 0.791 | -0.003 | +0.066 | 1 | no | noise |
|            | low  |   249 | -0.082 |  ≈0.199 | 0.506 | -0.132 | -0.058 | 0 | no | noise |
| **str_hold** | high |  2796 | +0.021 |  ≈0.262 | 0.565 | +0.006 | +0.044 | 0 | no | noise |
|            | mid  |  5002 | +0.004 |  ≈0.760 | 0.886 | -0.011 | +0.029 | 3 | no | noise |
|            | low  |  3790 | -0.010 |  ≈0.552 | 0.823 | -0.020 | +0.021 | 1 | desc | noise |
| **str_lag** | high |   850 | +0.065 |  ≈0.057 | 0.265 | +0.047 | +0.079 | 0 | no | noise |
|            | mid  |  1245 | +0.011 |  ≈0.708 | 0.843 | -0.037 | +0.033 | 1 | no | noise |
|            | low  |   666 | -0.089 |  ≈0.021 | 0.117 | -0.125 | -0.065 | 0 | no | borderline |
| **str_lead** | high |   400 | +0.084 |  ≈0.093 | 0.306 | +0.030 | +0.150 | 0 | no | noise |
|            | mid  |   589 | -0.017 |  ≈0.684 | 0.841 | -0.106 | +0.023 | 2 | no | noise |
|            | low  |   258 | -0.003 |  ≈0.963 | 0.980 | -0.060 | +0.054 | 3 | no | noise |
...
| brk_kumo_hi | ~inside | 0.0577 | 59.0% |     407 |      5 |   60.0% | +5.8%  |
...
| brk_tenkan_lo | ▼below  | 0.0517 | 54.8% |    5288 |    129 |   63.6% | +8.7%  |
...
| brk_tenkan_hi | ▼below  | 0.0473 | 57.0% |    4447 |    307 |   71.0% | +13.8% |
...
| brk_tenkan_lo | ▲above  | 0.0463 | 53.3% |    8871 |   3404 |   54.4% | -0.4%  |
| brk_bol    | ~inside | 0.0462 | 51.9% |     270 |      0 |       — | —      |
| brk_tenkan_lo | ~inside | 0.0462 | 56.5% |    2687 |    103 |   58.3% | +3.4%  |
| brk_tenkan_hi | ~inside | 0.0459 | 53.6% |    2385 |    122 |   53.3% | -3.9%  |
...
| brk_kumo_lo | ▲above  | 0.0438 | 52.8% |    1934 |    476 |   51.7% | -0.6%  |
| brk_kumo_hi | ▼below  | 0.0437 | 52.5% |     968 |      0 |       — | —      |
| rev_lo     | ▲above  | 0.0437 | 52.9% |    3342 |      0 |       — | —      |
| brk_tenkan_hi | ▲above  | 0.0427 | 49.8% |   11054 |   3855 |   56.2% | -1.0%  |
| brk_kumo_lo | ~inside | 0.0426 | 56.7% |     397 |     16 |   68.8% | +16.5% |
...
| brk_kumo_hi | ▲above  | 0.0395 | 48.5% |    2822 |    727 |   54.2% | -0.0%  |
...
| brk_wall   | 0 | — | — | — | — | — |
| brk_floor  | 0 | — | — | — | — | — |
| brk_kumo_hi |     732 |    54.2% |      732 |     54.2% |  +0.0% |      100% |
| brk_kumo_lo |     492 |    52.2% |      492 |     52.2% |  +0.0% |      100% |
| brk_tenkan_hi |    4284 |    57.2% |     4284 |     57.2% |  +0.0% |      100% |
| brk_tenkan_lo |    3636 |    54.8% |     3636 |     54.8% |  +0.0% |      100% |
| chiko_hi   | 0 | — | — | — | — | — |
| chiko_lo   | 0 | — | — | — | — | — |
| rev_lo     | 0 | — | — | — | — | — |
| rev_hi     | 0 | — | — | — | — | — |
...
Probe run: 2026-05-18.

**Baseline arm (7 signs)**: str_hold, str_lead, str_lag, brk_sma, brk_bol, rev_lo, rev_nlo

**Expanded arm (+3 ichimoku _hi)**: brk_kumo_hi, brk_tenkan_hi, chiko_hi

Same ZsTpSl(2.0,2.0,0.3) exit, same portfolio cap, same 10-bar cooldown.  N=3 is the recommended gate per [confluence_strategy_backtest](benchmark.md#confluence-strategy-ab-n1-2-3).
...
|----|---:|---:|---:|---:|---:|---:|
| FY2019 | 40 | -3.82 | 33 | -4.34 | -0.52 | -7 |
| FY2020 | 38 | +6.24 | 45 | +7.99 | +1.75 | +7 |
| FY2021 | 35 | -1.30 | 34 | -4.99 | -3.69 | -1 |
| FY2022 | 28 | +2.71 | 31 | +0.53 | -2.18 | +3 |
| FY2023 | 37 | +2.26 | 37 | +7.20 | +4.94 | +0 |
| FY2024 | 34 | +2.06 | 33 | -4.07 | -6.12 | -1 |
| FY2025 | 37 | +1.39 | 41 | +4.64 | +3.25 | +4 |

#### N ≥ 2

| FY | base trades | base Sharpe | expn trades | expn Sharpe | Δ Sharpe | Δ trades |
|----|---:|---:|---:|---:|---:|---:|
| FY2019 | 25 | -1.63 | 34 | -2.42 | -0.79 | +9 |
| FY2020 | 29 | +9.23 | 34 | +8.26 | -0.98 | +5 |
| FY2021 | 36 | -1.52 | 35 | -4.85 | -3.33 | -1 |
| FY2022 | 30 | +3.86 | 31 | +0.22 | -3.64 | +1 |
| FY2023 | 35 | +9.45 | 37 | +9.67 | +0.22 | +2 |
| FY2024 | 31 | -0.59 | 38 | +2.36 | +2.95 | +7 |
| FY2025 | 36 | +5.91 | 38 | +8.55 | +2.64 | +2 |

#### N ≥ 3

| FY | base trades | base Sharpe | expn trades | expn Sharpe | Δ Sharpe | Δ trades |
|----|---:|---:|---:|---:|---:|---:|
| FY2019 | 12 | -5.26 | 25 | -0.24 | +5.02 | +13 |
| FY2020 | 24 | +7.95 | 36 | +5.01 | -2.94 | +12 |
| FY2021 | 29 | +1.55 | 31 | -1.88 | -3.42 | +2 |
| FY2022 | 22 | +3.35 | 30 | +3.06 | -0.29 | +8 |
| FY2023 | 23 | +9.10 | 37 | +11.07 | +1.96 | +14 |
| FY2024 | 30 | +1.55 | 29 | +1.24 | -0.31 | -1 |
| FY2025 | 25 | +8.37 | 37 | +7.21 | -1.16 | +12 |

### Aggregate (FY-equal-weighted across all FYs with trades)

| N gate | arm | total trades | avg Sharpe | avg mean_r | avg win% |
|--------|-----|---:|---:|---:|---:|
| N ≥ 1 | baseline | 249 | **+1.36** | +0.77% | 52% |
| N ≥ 1 | expanded | 254 | **+0.99** | +0.36% | 52% |

| N ≥ 2 | baseline | 222 | **+3.53** | +1.92% | 58% |
| N ≥ 2 | expanded | 247 | **+3.11** | +1.60% | 57% |

| N ≥ 3 | baseline | 165 | **+3.80** | +1.97% | 59% |
| N ≥ 3 | expanded | 225 | **+3.64** | +2.11% | 60% |

### Decision rule applied

Ship the expanded set only if (a) avg Sharpe at N=3 ≥ baseline N=3 AND (b) ≥6 of 7 FYs remain non-negative.  Otherwise the 3 new _hi signs stay out of `ConfluenceSignStrategy._BULLISH_SIGNS` but remain in the catalogue for Daily-tab situational display.
