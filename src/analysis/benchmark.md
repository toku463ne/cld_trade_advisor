...
|------|---|-----|---|-----------|-----------|----------|--------|------------|----------|-------------|-------------|
| brk_hi_sideway |   680 |  47.2% | ≈0.145  |    0.0254 |    0.0515 |    12.891 | ≈0.941  | 599 (×1.1) |    46.7% | —             | —             |

#### FY2020 (2020-04-01 – 2021-03-31) · cluster=classified2019

| Sign | n | DR% | p | bench_flw | bench_rev | mean_bars | perm_p | dedup_n(×) | dedup_DR | bear_DR (p) | bull_DR (p) |
|------|---|-----|---|-----------|-----------|----------|--------|------------|----------|-------------|-------------|
| brk_hi_sideway |   642 |  52.8% | ≈0.155  |    0.0451 |    0.0289 |    12.791 | ≈0.076  | 574 (×1.1) |    54.4% | 59.5% (≈0.004) | 48.0% (≈0.443) |

#### FY2021 (2021-04-01 – 2022-03-31) · cluster=classified2020

| Sign | n | DR% | p | bench_flw | bench_rev | mean_bars | perm_p | dedup_n(×) | dedup_DR | bear_DR (p) | bull_DR (p) |
|------|---|-----|---|-----------|-----------|----------|--------|------------|----------|-------------|-------------|
| brk_hi_sideway |   644 |  51.1% | ≈0.581  |    0.0377 |    0.0416 |    12.615 | ≈0.302  | 582 (×1.1) |    51.4% | 53.0% (≈0.330) | 49.7% (≈0.918) |

#### FY2022 (2022-04-01 – 2023-03-31) · cluster=classified2021

| Sign | n | DR% | p | bench_flw | bench_rev | mean_bars | perm_p | dedup_n(×) | dedup_DR | bear_DR (p) | bull_DR (p) |
|------|---|-----|---|-----------|-----------|----------|--------|------------|----------|-------------|-------------|
| brk_hi_sideway |   633 |  48.0% | ≈0.320  |    0.0286 |    0.0295 |    11.619 | ≈0.863  | 547 (×1.2) |    47.9% | 51.0% (≈0.747) | 46.2% (≈0.130) |

#### FY2023 (2023-04-01 – 2024-03-31) · cluster=classified2022

| Sign | n | DR% | p | bench_flw | bench_rev | mean_bars | perm_p | dedup_n(×) | dedup_DR | bear_DR (p) | bull_DR (p) |
|------|---|-----|---|-----------|-----------|----------|--------|------------|----------|-------------|-------------|
| brk_hi_sideway |   878 |  54.8% | ≈0.005  |    0.0464 |    0.0267 |    12.787 | ≈0.002  | 779 (×1.1) |    55.3% | 50.0% (≈1.000) | 57.6% (<0.001) |

#### FY2024 (2024-04-01 – 2025-03-31) · cluster=classified2023

| Sign | n | DR% | p | bench_flw | bench_rev | mean_bars | perm_p | dedup_n(×) | dedup_DR | bear_DR (p) | bull_DR (p) |
|------|---|-----|---|-----------|-----------|----------|--------|------------|----------|-------------|-------------|
| brk_hi_sideway |   524 |  53.4% | ≈0.116  |    0.0403 |    0.0345 |    12.263 | ≈0.060  | 463 (×1.1) |    51.8% | 61.8% (<0.001) | 48.3% (≈0.542) |

#### FY2025 (2025-04-01 – 2026-03-31) · cluster=classified2024

| Sign | n | DR% | p | bench_flw | bench_rev | mean_bars | perm_p | dedup_n(×) | dedup_DR | bear_DR (p) | bull_DR (p) |
|------|---|-----|---|-----------|-----------|----------|--------|------------|----------|-------------|-------------|
| brk_hi_sideway |  1005 |  59.6% | <0.001  |    0.0536 |    0.0236 |    12.605 | <0.001  | 881 (×1.1) |    59.3% | 65.7% (<0.001) | 55.6% (≈0.006) |
...
| brk_sma    | — | — | — | — | — | — | — | — | — |
| brk_bol    | — | — | — | — | — | — | — | — | — |
| brk_hi_sideway |   7 |    5006 |      53.0% | <0.001   |       0.0396 |        0.0338 |       2/7 | 50.0–65.7%    | 46.2–57.6%    |
| rev_lo     | — | — | — | — | — | — | — | — | — |
| rev_hi     | — | — | — | — | — | — | — | — | — |
| rev_nhi    | — | — | — | — | — | — | — | — | — |
| rev_nlo    | — | — | — | — | — | — | — | — | — |
...
|------|------|---|---|---|---|-----------|-----------|-------|------|---------|
| **brk_bol** | high |   902 | +0.028 |  ≈0.400 | 0.737 | +0.006 | +0.048 | 0 | no | noise |
|            | mid  |  1269 | +0.011 |  ≈0.691 | 0.917 | -0.008 | +0.037 | 2 | no | noise |
|            | low  |   814 | +0.080 |  ≈0.022 | 0.152 | +0.063 | +0.095 | 0 | no | borderline |
| **brk_hi_sideway** | high |  1530 | +0.028 |  ≈0.282 | 0.657 | +0.015 | +0.042 | 0 | no | noise |
|            | mid  |  1791 | -0.021 |  ≈0.364 | 0.709 | -0.040 | -0.001 | 0 | no | noise |
|            | low  |   980 | +0.092 |  ≈0.004 | 0.069 | +0.066 | +0.130 | 0 | asc | borderline |
| **brk_sma** | high |   521 | -0.001 |  ≈0.990 | 0.990 | -0.031 | +0.031 | 4 | no | noise |
|            | mid  |   476 | +0.082 |  ≈0.073 | 0.367 | +0.058 | +0.113 | 0 | no | noise |
|            | low  |   230 | +0.027 |  ≈0.687 | 0.917 | +0.006 | +0.039 | 0 | no | noise |
| **corr_flip** | low  |   695 | -0.063 |  ≈0.099 | 0.386 | -0.080 | -0.042 | 0 | no | noise |
| **corr_shift** | mid  |   268 | +0.011 |  ≈0.861 | 0.972 | -0.048 | +0.094 | 2 | no | noise |
|            | low  |   877 | +0.031 |  ≈0.356 | 0.709 | -0.007 | +0.074 | 1 | no | noise |
| **div_gap** | high |   811 | +0.154 |  <0.001 | 0.000 | +0.116 | +0.190 | 0 | asc | moderate |
|            | mid  |  1567 | +0.060 |  ≈0.017 | 0.152 | +0.041 | +0.072 | 0 | no | borderline |
|            | low  |  1310 | -0.006 |  ≈0.832 | 0.972 | -0.022 | +0.007 | 3 | no | noise |
| **div_peer** | high |   223 | +0.003 |  ≈0.962 | 0.990 | -0.036 | +0.047 | 4 | no | noise |
|            | mid  |   279 | -0.074 |  ≈0.220 | 0.642 | -0.088 | -0.041 | 0 | no | noise |
| **rev_hi** | high |  3215 | -0.024 |  ≈0.177 | 0.621 | -0.030 | -0.018 | 0 | no | noise |
|            | mid  |  3469 | -0.007 |  ≈0.676 | 0.917 | -0.013 | +0.003 | 1 | no | noise |
|            | low  |  1883 | +0.004 |  ≈0.846 | 0.972 | -0.026 | +0.038 | 2 | no | noise |
| **rev_lo** | high |  3101 | +0.001 |  ≈0.954 | 0.990 | -0.021 | +0.021 | 3 | no | noise |
|            | mid  |  2920 | +0.014 |  ≈0.437 | 0.765 | -0.012 | +0.030 | 2 | no | noise |
|            | low  |  1455 | +0.024 |  ≈0.362 | 0.709 | +0.013 | +0.041 | 0 | no | noise |
| **rev_nlo** | high |  1996 | +0.025 |  ≈0.260 | 0.656 | -0.077 | +0.076 | 1 | asc | noise |
|            | mid  |   758 | +0.024 |  ≈0.508 | 0.847 | -0.003 | +0.066 | 1 | no | noise |
|            | low  |   249 | -0.082 |  ≈0.199 | 0.633 | -0.132 | -0.058 | 0 | no | noise |
| **str_hold** | high |  2796 | +0.021 |  ≈0.262 | 0.656 | +0.006 | +0.044 | 0 | no | noise |
|            | mid  |  5002 | +0.004 |  ≈0.760 | 0.950 | -0.011 | +0.029 | 3 | no | noise |
|            | low  |  3790 | -0.010 |  ≈0.552 | 0.878 | -0.020 | +0.021 | 1 | desc | noise |
| **str_lag** | high |   850 | +0.065 |  ≈0.057 | 0.332 | +0.047 | +0.079 | 0 | no | noise |
|            | mid  |  1245 | +0.011 |  ≈0.708 | 0.917 | -0.037 | +0.033 | 1 | no | noise |
|            | low  |   666 | -0.089 |  ≈0.021 | 0.152 | -0.125 | -0.065 | 0 | no | borderline |
| **str_lead** | high |   400 | +0.084 |  ≈0.093 | 0.386 | +0.030 | +0.150 | 0 | no | noise |
|            | mid  |   589 | -0.017 |  ≈0.684 | 0.917 | -0.106 | +0.023 | 2 | no | noise |
|            | low  |   258 | -0.003 |  ≈0.963 | 0.990 | -0.060 | +0.054 | 3 | no | noise |
...
Ranking cells: 38 (sign × kumo_state, min_n=30)  
...
| brk_hi_sideway | ~inside | 0.0492 | 62.0% |     368 |     10 |   80.0% | +20.4% |
...
| brk_hi_sideway | ▲above  | 0.0382 | 49.8% |    2199 |    995 |   59.4% | -0.2%  |
...
| brk_sma    | 0 | — | — | — | — | — |
| brk_bol    | 0 | — | — | — | — | — |
| brk_hi_sideway |    1005 |    59.6% |     1005 |     59.6% |  +0.0% |      100% |
| rev_lo     | 0 | — | — | — | — | — |
| rev_hi     | 0 | — | — | — | — | — |
| rev_nhi    | 0 | — | — | — | — | — |
| rev_nlo    | 0 | — | — | — | — | — |
